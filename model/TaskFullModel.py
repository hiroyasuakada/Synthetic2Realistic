...
class TNetFullModel(BaseModel):
    ...
    def initialize(self, opt, labeled_dataset=None, unlabeled_dataset=None):
        ...
        self.loss_names = ['lab_s', 'lab_smooth_s']
    ...
    def backward_task(self):
        ...
        self.loss_lab_smooth_s = task.get_smooth_weight(self.lab_s_g, img_real, size - 1) * self.opt.lambda_smooth
